...
export const Header = () => {
    ...
    return (
        <header id="header">
            ...
            <button type="button" id="btn-open" aria-label="Abrir Menu" onClick={() => setIsOpen(true)} >
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32" > <path d="M0,0H32V32H0Z" fill="none" /> <path d="M3,18H29V16H3Zm0-5H29V11H3ZM3,6V8H29V6Z" transform="translate(0 4)" />
                </svg>
            </button>
            <div className="menu logged">
                <nav>
                    <button type="button" id="btn-close" data-close="menu" aria-label="fechar" onClick={() => setIsOpen(false)}>
                        <svg
